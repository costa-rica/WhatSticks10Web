...
import os
import json
from ws_models import sess,text, Users, Base, engine, \
...
@login_required
def admin_page():
    logger_bp_admin.info('- in admin_db -')
    # logger_bp_admin.info(f"current_user.admin_users_permission: {current_user.admin_users_permission_users_permission}")
...
def admin_db_download():
    ...
    logger_bp_admin.info(f"current_user.admin_users_permission: {current_user.admin_users_permission}")
    # logger_bp_admin.info(f"current_user.admin_users_permission: {current_user}")
